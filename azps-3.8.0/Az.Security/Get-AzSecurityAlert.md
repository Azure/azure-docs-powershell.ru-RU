...
ms.locfileid: "94074685"
---
# <span data-ttu-id="cc5ee-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="cc5ee-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="cc5ee-102">КРАТКИй обзор</span><span class="sxs-lookup"><span data-stu-id="cc5ee-102">SYNOPSIS</span></span>
<span data-ttu-id="cc5ee-103">Получение оповещений системы безопасности, обнаруженных центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="cc5ee-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="cc5ee-104">Максимальное</span><span class="sxs-lookup"><span data-stu-id="cc5ee-104">SYNTAX</span></span>

### <span data-ttu-id="cc5ee-105">SubscriptionScope (по умолчанию)</span><span class="sxs-lookup"><span data-stu-id="cc5ee-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="cc5ee-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="cc5ee-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="cc5ee-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="cc5ee-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="cc5ee-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="cc5ee-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="cc5ee-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="cc5ee-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="cc5ee-110">NОПИСАНИЕ</span><span class="sxs-lookup"><span data-stu-id="cc5ee-110">DESCRIPTION</span></span>
<span data-ttu-id="cc5ee-111">Получение оповещений системы безопасности, обнаруженных центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="cc5ee-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="cc5ee-112">ИЛЛЮСТРИРУЮТ</span><span class="sxs-lookup"><span data-stu-id="cc5ee-112">EXAMPLES</span></span>

### <span data-ttu-id="cc5ee-113">Пример 1</span><span class="sxs-lookup"><span data-stu-id="cc5ee-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="cc5ee-114">Возвращает все оповещения системы безопасности, обнаруженные для ресурсов в подписке.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="cc5ee-115">Пример 2</span><span class="sxs-lookup"><span data-stu-id="cc5ee-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="cc5ee-116">Возвращает все оповещения системы безопасности, обнаруженные в ресурсах, которые находятся в группе ресурсов "myService1".</span><span class="sxs-lookup"><span data-stu-id="cc5ee-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="cc5ee-117">Пример 3</span><span class="sxs-lookup"><span data-stu-id="cc5ee-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="cc5ee-118">Получает особое предупреждение системы безопасности, обнаруженное в ресурсах, которые находятся в группе ресурсов "myService1".</span><span class="sxs-lookup"><span data-stu-id="cc5ee-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="cc5ee-119">ПАРАМЕТРЫ</span><span class="sxs-lookup"><span data-stu-id="cc5ee-119">PARAMETERS</span></span>

### <span data-ttu-id="cc5ee-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="cc5ee-120">-DefaultProfile</span></span>
<span data-ttu-id="cc5ee-121">Учетные данные, учетная запись, клиент и подписка, используемые для связи с Azure.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="cc5ee-122">-Location</span><span class="sxs-lookup"><span data-stu-id="cc5ee-122">-Location</span></span>
<span data-ttu-id="cc5ee-123">Поиска.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-123">Location.</span></span>
...
### <span data-ttu-id="cc5ee-124">-Name (имя)</span><span class="sxs-lookup"><span data-stu-id="cc5ee-124">-Name</span></span>
<span data-ttu-id="cc5ee-125">Название ресурса.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-125">Resource name.</span></span>
...
### <span data-ttu-id="cc5ee-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="cc5ee-126">-ResourceGroupName</span></span>
<span data-ttu-id="cc5ee-127">Имя группы ресурсов.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-127">Resource group name.</span></span>
...
### <span data-ttu-id="cc5ee-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="cc5ee-128">-ResourceId</span></span>
<span data-ttu-id="cc5ee-129">Идентификатор ресурса.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-129">Resource ID.</span></span>
...
### <span data-ttu-id="cc5ee-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="cc5ee-130">CommonParameters</span></span>
<span data-ttu-id="cc5ee-131">Этот командлет поддерживает общие параметры:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-of Variable,-out,-PipelineVariable,-Verbose, и-WarningAction.</span><span class="sxs-lookup"><span data-stu-id="cc5ee-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="cc5ee-132">Дополнительные сведения можно найти в разделе about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="cc5ee-132">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="cc5ee-133">ВХОДНЫЕ данные</span><span class="sxs-lookup"><span data-stu-id="cc5ee-133">INPUTS</span></span>

### <span data-ttu-id="cc5ee-134">System. String</span><span class="sxs-lookup"><span data-stu-id="cc5ee-134">System.String</span></span>

## <span data-ttu-id="cc5ee-135">НАПРЯЖЕНИЕ</span><span class="sxs-lookup"><span data-stu-id="cc5ee-135">OUTPUTS</span></span>

### <span data-ttu-id="cc5ee-136">Microsoft. Azure. Commands. Security. Models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="cc5ee-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="cc5ee-137">Пуск</span><span class="sxs-lookup"><span data-stu-id="cc5ee-137">NOTES</span></span>

## <span data-ttu-id="cc5ee-138">ДОПОЛНИТЕЛЬНЫЕ ССЫЛКИ</span><span class="sxs-lookup"><span data-stu-id="cc5ee-138">RELATED LINKS</span></span>
