...
ms.locfileid: "101970675"
---
# <span data-ttu-id="abb24-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="abb24-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="abb24-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="abb24-102">SYNOPSIS</span></span>
<span data-ttu-id="abb24-103">Сведения о конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="abb24-104">СИНТАКСИС</span><span class="sxs-lookup"><span data-stu-id="abb24-104">SYNTAX</span></span>

### <span data-ttu-id="abb24-105">Список (по умолчанию)</span><span class="sxs-lookup"><span data-stu-id="abb24-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="abb24-106">Получить</span><span class="sxs-lookup"><span data-stu-id="abb24-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="abb24-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="abb24-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="abb24-108">ОПИСАНИЕ</span><span class="sxs-lookup"><span data-stu-id="abb24-108">DESCRIPTION</span></span>
<span data-ttu-id="abb24-109">Сведения о конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="abb24-110">ПРИМЕРЫ</span><span class="sxs-lookup"><span data-stu-id="abb24-110">EXAMPLES</span></span>

### <span data-ttu-id="abb24-111">Пример 1. Список всех конфигураций в соответствии с MariaDB</span><span class="sxs-lookup"><span data-stu-id="abb24-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="abb24-112">Эта команда содержит список всех конфигураций в соответствии с MariaDB.</span><span class="sxs-lookup"><span data-stu-id="abb24-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="abb24-113">Пример 2. Настройка MariaDB</span><span class="sxs-lookup"><span data-stu-id="abb24-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="abb24-114">Эта команда получает конфигурацию MariaDB.</span><span class="sxs-lookup"><span data-stu-id="abb24-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="abb24-115">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="abb24-115">PARAMETERS</span></span>

### <span data-ttu-id="abb24-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="abb24-116">-DefaultProfile</span></span>
<span data-ttu-id="abb24-117">Учетные данные, учетная запись, клиент и подписка, используемые для связи с Azure.</span><span class="sxs-lookup"><span data-stu-id="abb24-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="abb24-120">-Name</span><span class="sxs-lookup"><span data-stu-id="abb24-120">-Name</span></span>
<span data-ttu-id="abb24-121">Имя конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="abb24-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="abb24-122">-ResourceGroupName</span></span>
<span data-ttu-id="abb24-123">Имя группы ресурсов, которая содержит ресурс.</span><span class="sxs-lookup"><span data-stu-id="abb24-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="abb24-124">Это значение можно получить через API Диспетчера ресурсов Azure или на портале.</span><span class="sxs-lookup"><span data-stu-id="abb24-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="abb24-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="abb24-125">-ServerName</span></span>
<span data-ttu-id="abb24-126">Имя сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-126">The name of the server.</span></span>
...
### <span data-ttu-id="abb24-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="abb24-127">-SubscriptionId</span></span>
<span data-ttu-id="abb24-128">Идентификатор подписки, который определяет подписку Azure.</span><span class="sxs-lookup"><span data-stu-id="abb24-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="abb24-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="abb24-129">CommonParameters</span></span>
<span data-ttu-id="abb24-130">Этот cmdlet поддерживает общие параметры: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="abb24-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="abb24-131">Дополнительные сведения см. [в about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="abb24-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="abb24-132">INPUTS</span><span class="sxs-lookup"><span data-stu-id="abb24-132">INPUTS</span></span>

### <span data-ttu-id="abb24-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="abb24-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="abb24-134">OUTPUTS</span><span class="sxs-lookup"><span data-stu-id="abb24-134">OUTPUTS</span></span>

### <span data-ttu-id="abb24-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="abb24-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="abb24-136">ПРИМЕЧАНИЯ</span><span class="sxs-lookup"><span data-stu-id="abb24-136">NOTES</span></span>

<span data-ttu-id="abb24-137">ALIASES</span><span class="sxs-lookup"><span data-stu-id="abb24-137">ALIASES</span></span>

<span data-ttu-id="abb24-138">СЛОЖНЫЕ СВОЙСТВА ПАРАМЕТРОВ</span><span class="sxs-lookup"><span data-stu-id="abb24-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="abb24-139">Чтобы создать описанные ниже параметры, создайте hash table, содержащую нужные свойства.</span><span class="sxs-lookup"><span data-stu-id="abb24-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="abb24-140">Чтобы получить сведения о hash tables, запустите Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="abb24-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="abb24-141">INPUTOBJECT <IMariaDbIdentity> : Параметр identity</span><span class="sxs-lookup"><span data-stu-id="abb24-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="abb24-142">`[ConfigurationName <String>]`: имя конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="abb24-143">`[DatabaseName <String>]`: имя базы данных.</span><span class="sxs-lookup"><span data-stu-id="abb24-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="abb24-144">`[FirewallRuleName <String>]`: Имя правила брандмауэра сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="abb24-145">`[Id <String>]`: путь удостоверения ресурса</span><span class="sxs-lookup"><span data-stu-id="abb24-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="abb24-146">`[LocationName <String>]`: название расположения.</span><span class="sxs-lookup"><span data-stu-id="abb24-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="abb24-147">`[ResourceGroupName <String>]`: Имя группы ресурсов, которая содержит ресурс.</span><span class="sxs-lookup"><span data-stu-id="abb24-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="abb24-148">Это значение можно получить через API Диспетчера ресурсов Azure или на портале.</span><span class="sxs-lookup"><span data-stu-id="abb24-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="abb24-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: имя политики оповещения системы безопасности.</span><span class="sxs-lookup"><span data-stu-id="abb24-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="abb24-150">`[ServerName <String>]`: имя сервера.</span><span class="sxs-lookup"><span data-stu-id="abb24-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="abb24-151">`[SubscriptionId <String>]`. Идентификатор подписки, который определяет подписку Azure.</span><span class="sxs-lookup"><span data-stu-id="abb24-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="abb24-152">`[VirtualNetworkRuleName <String>]`: имя виртуального правила сети.</span><span class="sxs-lookup"><span data-stu-id="abb24-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="abb24-153">СВЯЗАННЫЕ ССЫЛКИ</span><span class="sxs-lookup"><span data-stu-id="abb24-153">RELATED LINKS</span></span>
