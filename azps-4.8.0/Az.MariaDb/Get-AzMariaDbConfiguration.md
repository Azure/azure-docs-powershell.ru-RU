...
ms.locfileid: "94079557"
---
# <span data-ttu-id="c1dc9-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="c1dc9-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="c1dc9-102">КРАТКИй обзор</span><span class="sxs-lookup"><span data-stu-id="c1dc9-102">SYNOPSIS</span></span>
<span data-ttu-id="c1dc9-103">Получает сведения о конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="c1dc9-104">Максимальное</span><span class="sxs-lookup"><span data-stu-id="c1dc9-104">SYNTAX</span></span>

### <span data-ttu-id="c1dc9-105">Список (по умолчанию)</span><span class="sxs-lookup"><span data-stu-id="c1dc9-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="c1dc9-106">Получить</span><span class="sxs-lookup"><span data-stu-id="c1dc9-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="c1dc9-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="c1dc9-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="c1dc9-108">NОПИСАНИЕ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-108">DESCRIPTION</span></span>
<span data-ttu-id="c1dc9-109">Получает сведения о конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="c1dc9-110">ИЛЛЮСТРИРУЮТ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-110">EXAMPLES</span></span>

### <span data-ttu-id="c1dc9-111">Пример 1: список всех конфигураций в MariaDB</span><span class="sxs-lookup"><span data-stu-id="c1dc9-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="c1dc9-112">Эта команда выводит все настройки в MariaDB.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="c1dc9-113">Пример 2: получение конфигурации MariaDB</span><span class="sxs-lookup"><span data-stu-id="c1dc9-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="c1dc9-114">Эта команда возвращает конфигурацию MariaDB.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="c1dc9-115">ПАРАМЕТРЫ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-115">PARAMETERS</span></span>

### <span data-ttu-id="c1dc9-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="c1dc9-116">-DefaultProfile</span></span>
<span data-ttu-id="c1dc9-117">Учетные данные, учетная запись, клиент и подписка, используемые для связи с Azure.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="c1dc9-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="c1dc9-118">-InputObject</span></span>
<span data-ttu-id="c1dc9-119">Параметр идентификатора для создания щелкните раздел заметок для свойств INPUTOBJECT и создайте хэш-таблицу.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="c1dc9-120">-Name (имя)</span><span class="sxs-lookup"><span data-stu-id="c1dc9-120">-Name</span></span>
<span data-ttu-id="c1dc9-121">Имя конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="c1dc9-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="c1dc9-122">-ResourceGroupName</span></span>
<span data-ttu-id="c1dc9-123">Имя группы ресурсов, содержащей ресурс.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="c1dc9-124">Это значение можно получить в API-интерфейсе диспетчера ресурсов Azure или на портале.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="c1dc9-125">-ИмяСервера</span><span class="sxs-lookup"><span data-stu-id="c1dc9-125">-ServerName</span></span>
<span data-ttu-id="c1dc9-126">Имя сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-126">The name of the server.</span></span>
...
### <span data-ttu-id="c1dc9-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="c1dc9-127">-SubscriptionId</span></span>
<span data-ttu-id="c1dc9-128">Идентификатор подписки, определяющий подписку на Azure.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="c1dc9-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="c1dc9-129">CommonParameters</span></span>
<span data-ttu-id="c1dc9-130">Этот командлет поддерживает общие параметры:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-of Variable,-out,-PipelineVariable,-Verbose, и-WarningAction.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="c1dc9-131">Дополнительные сведения можно найти в разделе [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="c1dc9-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="c1dc9-132">ВХОДНЫЕ данные</span><span class="sxs-lookup"><span data-stu-id="c1dc9-132">INPUTS</span></span>

### <span data-ttu-id="c1dc9-133">Microsoft. Azure. PowerShell. командлеты. MariaDb. Models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="c1dc9-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="c1dc9-134">НАПРЯЖЕНИЕ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-134">OUTPUTS</span></span>

### <span data-ttu-id="c1dc9-135">Microsoft. Azure. PowerShell. командлеты. MariaDb. Models. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="c1dc9-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="c1dc9-136">Пуск</span><span class="sxs-lookup"><span data-stu-id="c1dc9-136">NOTES</span></span>

<span data-ttu-id="c1dc9-137">СВЯЗЫВАЮТ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-137">ALIASES</span></span>

<span data-ttu-id="c1dc9-138">СВОЙСТВА СЛОЖНЫХ ПАРАМЕТРОВ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="c1dc9-139">Чтобы создать параметры, описанные ниже, создайте хэш-таблицу, содержащую соответствующие свойства.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="c1dc9-140">Для получения сведений о хэш-таблицах запустите Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="c1dc9-141">INPUTOBJECT <IMariaDbIdentity> : параметр Identity</span><span class="sxs-lookup"><span data-stu-id="c1dc9-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="c1dc9-142">`[ConfigurationName <String>]`: Имя конфигурации сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="c1dc9-143">`[DatabaseName <String>]`: Имя базы данных.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="c1dc9-144">`[FirewallRuleName <String>]`: Имя правила брандмауэра сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="c1dc9-145">`[Id <String>]`: Путь к удостоверению ресурса</span><span class="sxs-lookup"><span data-stu-id="c1dc9-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="c1dc9-146">`[LocationName <String>]`: Имя расположения.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="c1dc9-147">`[ResourceGroupName <String>]`: Имя группы ресурсов, содержащей ресурс.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="c1dc9-148">Это значение можно получить в API-интерфейсе диспетчера ресурсов Azure или на портале.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="c1dc9-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Имя политики оповещения системы безопасности.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="c1dc9-150">`[ServerName <String>]`: Имя сервера.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="c1dc9-151">`[SubscriptionId <String>]`: Идентификатор подписки, определяющий подписку на Azure.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="c1dc9-152">`[VirtualNetworkRuleName <String>]`: Имя правила виртуальной сети.</span><span class="sxs-lookup"><span data-stu-id="c1dc9-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="c1dc9-153">ДОПОЛНИТЕЛЬНЫЕ ССЫЛКИ</span><span class="sxs-lookup"><span data-stu-id="c1dc9-153">RELATED LINKS</span></span>
