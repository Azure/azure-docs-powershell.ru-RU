...
ms.locfileid: "98517729"
---
# <span data-ttu-id="db89b-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="db89b-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="db89b-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="db89b-102">SYNOPSIS</span></span>
<span data-ttu-id="db89b-103">Получает оповещения системы безопасности, обнаруженные Центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="db89b-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="db89b-104">СИНТАКСИС</span><span class="sxs-lookup"><span data-stu-id="db89b-104">SYNTAX</span></span>

### <span data-ttu-id="db89b-105">SubscriptionScope (по умолчанию)</span><span class="sxs-lookup"><span data-stu-id="db89b-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="db89b-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="db89b-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="db89b-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="db89b-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="db89b-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="db89b-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="db89b-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="db89b-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="db89b-110">ОПИСАНИЕ</span><span class="sxs-lookup"><span data-stu-id="db89b-110">DESCRIPTION</span></span>
<span data-ttu-id="db89b-111">Получает оповещения системы безопасности, обнаруженные Центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="db89b-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="db89b-112">ПРИМЕРЫ</span><span class="sxs-lookup"><span data-stu-id="db89b-112">EXAMPLES</span></span>

### <span data-ttu-id="db89b-113">Пример 1</span><span class="sxs-lookup"><span data-stu-id="db89b-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="db89b-114">Все оповещения системы безопасности, обнаруженные на ресурсах в подписке</span><span class="sxs-lookup"><span data-stu-id="db89b-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="db89b-115">Пример 2</span><span class="sxs-lookup"><span data-stu-id="db89b-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="db89b-116">Все оповещения системы безопасности, обнаруженные для ресурсов в группе ресурсов "МойСлужба1".</span><span class="sxs-lookup"><span data-stu-id="db89b-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="db89b-117">Пример 3</span><span class="sxs-lookup"><span data-stu-id="db89b-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="db89b-118">Получает определенное оповещение системы безопасности, которое было обнаружено для ресурсов в группе ресурсов "МойСлужба1"</span><span class="sxs-lookup"><span data-stu-id="db89b-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="db89b-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="db89b-119">PARAMETERS</span></span>

### <span data-ttu-id="db89b-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="db89b-120">-DefaultProfile</span></span>
<span data-ttu-id="db89b-121">Учетные данные, учетная запись, клиент и подписка, используемые для связи с Azure.</span><span class="sxs-lookup"><span data-stu-id="db89b-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="db89b-122">-Location</span><span class="sxs-lookup"><span data-stu-id="db89b-122">-Location</span></span>
<span data-ttu-id="db89b-123">"Расположение".</span><span class="sxs-lookup"><span data-stu-id="db89b-123">Location.</span></span>
...
### <span data-ttu-id="db89b-124">-Name</span><span class="sxs-lookup"><span data-stu-id="db89b-124">-Name</span></span>
<span data-ttu-id="db89b-125">Название ресурса.</span><span class="sxs-lookup"><span data-stu-id="db89b-125">Resource name.</span></span>
...
### <span data-ttu-id="db89b-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="db89b-126">-ResourceGroupName</span></span>
<span data-ttu-id="db89b-127">Имя группы ресурсов.</span><span class="sxs-lookup"><span data-stu-id="db89b-127">Resource group name.</span></span>
...
### <span data-ttu-id="db89b-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="db89b-128">-ResourceId</span></span>
<span data-ttu-id="db89b-129">ИД ресурса.</span><span class="sxs-lookup"><span data-stu-id="db89b-129">Resource ID.</span></span>
...
### <span data-ttu-id="db89b-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="db89b-130">CommonParameters</span></span>
<span data-ttu-id="db89b-131">Этот cmdlet поддерживает общие параметры: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="db89b-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="db89b-132">Дополнительные сведения см. [в about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="db89b-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="db89b-133">INPUTS</span><span class="sxs-lookup"><span data-stu-id="db89b-133">INPUTS</span></span>

### <span data-ttu-id="db89b-134">System.String</span><span class="sxs-lookup"><span data-stu-id="db89b-134">System.String</span></span>

## <span data-ttu-id="db89b-135">OUTPUTS</span><span class="sxs-lookup"><span data-stu-id="db89b-135">OUTPUTS</span></span>

### <span data-ttu-id="db89b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="db89b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="db89b-137">ПРИМЕЧАНИЯ</span><span class="sxs-lookup"><span data-stu-id="db89b-137">NOTES</span></span>

## <span data-ttu-id="db89b-138">СВЯЗАННЫЕ ССЫЛКИ</span><span class="sxs-lookup"><span data-stu-id="db89b-138">RELATED LINKS</span></span>
