...
<span data-ttu-id="483b9-126">Следующий код позволяет экспортировать секрет:</span><span class="sxs-lookup"><span data-stu-id="483b9-126">The following code will allow you to export the secret:</span></span>
