...
ms.locfileid: "93560636"
---
# <span data-ttu-id="2ad30-101">Get-AzureRmSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="2ad30-101">Get-AzureRmSecurityAlert</span></span>

## <span data-ttu-id="2ad30-102">КРАТКИй обзор</span><span class="sxs-lookup"><span data-stu-id="2ad30-102">SYNOPSIS</span></span>
<span data-ttu-id="2ad30-103">Получение оповещений системы безопасности, обнаруженных центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="2ad30-103">Gets security alerts that were detected by Azure Security Center</span></span>

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## <span data-ttu-id="2ad30-104">Максимальное</span><span class="sxs-lookup"><span data-stu-id="2ad30-104">SYNTAX</span></span>

### <span data-ttu-id="2ad30-105">SubscriptionScope (по умолчанию)</span><span class="sxs-lookup"><span data-stu-id="2ad30-105">SubscriptionScope (Default)</span></span>
```
Get-AzureRmSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="2ad30-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="2ad30-106">ResourceGroupScope</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="2ad30-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="2ad30-107">ResourceGroupLevelResource</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="2ad30-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="2ad30-108">SubscriptionLevelResource</span></span>
```
Get-AzureRmSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="2ad30-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="2ad30-109">ResourceId</span></span>
```
Get-AzureRmSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="2ad30-110">NОПИСАНИЕ</span><span class="sxs-lookup"><span data-stu-id="2ad30-110">DESCRIPTION</span></span>
<span data-ttu-id="2ad30-111">Получение оповещений системы безопасности, обнаруженных центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="2ad30-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="2ad30-112">ИЛЛЮСТРИРУЮТ</span><span class="sxs-lookup"><span data-stu-id="2ad30-112">EXAMPLES</span></span>

### <span data-ttu-id="2ad30-113">Пример 1</span><span class="sxs-lookup"><span data-stu-id="2ad30-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="2ad30-114">Возвращает все оповещения системы безопасности, обнаруженные в resoruces в рамках подписки.</span><span class="sxs-lookup"><span data-stu-id="2ad30-114">Gets all the security alerts that were detected on resoruces inside a subscription</span></span>

### <span data-ttu-id="2ad30-115">Пример 2</span><span class="sxs-lookup"><span data-stu-id="2ad30-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="2ad30-116">Возвращает все оповещения системы безопасности, обнаруженные в resoruces в группе ресурсов "myService1".</span><span class="sxs-lookup"><span data-stu-id="2ad30-116">Gets all the security alerts that were detected on resoruces inside the "myService1" resource group</span></span>

### <span data-ttu-id="2ad30-117">Пример 3</span><span class="sxs-lookup"><span data-stu-id="2ad30-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="2ad30-118">Получает особое предупреждение системы безопасности, обнаруженное в resoruces в группе ресурсов "myService1".</span><span class="sxs-lookup"><span data-stu-id="2ad30-118">Gets a specific security alert that were detected on resoruces inside the "myService1" resource group</span></span>

## <span data-ttu-id="2ad30-119">ПАРАМЕТРЫ</span><span class="sxs-lookup"><span data-stu-id="2ad30-119">PARAMETERS</span></span>

### <span data-ttu-id="2ad30-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="2ad30-120">-DefaultProfile</span></span>
<span data-ttu-id="2ad30-121">Учетные данные, учетная запись, клиент и подписка, используемые для связи с Azure.</span><span class="sxs-lookup"><span data-stu-id="2ad30-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="2ad30-122">-Location</span><span class="sxs-lookup"><span data-stu-id="2ad30-122">-Location</span></span>
<span data-ttu-id="2ad30-123">Поиска.</span><span class="sxs-lookup"><span data-stu-id="2ad30-123">Location.</span></span>
...
### <span data-ttu-id="2ad30-124">-Name (имя)</span><span class="sxs-lookup"><span data-stu-id="2ad30-124">-Name</span></span>
<span data-ttu-id="2ad30-125">Название ресурса.</span><span class="sxs-lookup"><span data-stu-id="2ad30-125">Resource name.</span></span>
...
### <span data-ttu-id="2ad30-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="2ad30-126">-ResourceGroupName</span></span>
<span data-ttu-id="2ad30-127">Имя группы ресурсов.</span><span class="sxs-lookup"><span data-stu-id="2ad30-127">Resource group name.</span></span>
...
### <span data-ttu-id="2ad30-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="2ad30-128">-ResourceId</span></span>
<span data-ttu-id="2ad30-129">Идентификатор ресурса.</span><span class="sxs-lookup"><span data-stu-id="2ad30-129">Resource ID.</span></span>
...
### <span data-ttu-id="2ad30-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="2ad30-130">CommonParameters</span></span>
<span data-ttu-id="2ad30-131">Этот командлет поддерживает общие параметры:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-of Variable,-out,-PipelineVariable,-Verbose, и-WarningAction.</span><span class="sxs-lookup"><span data-stu-id="2ad30-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="2ad30-132">Дополнительные сведения можно найти в разделе about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="2ad30-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="2ad30-133">ВХОДНЫЕ данные</span><span class="sxs-lookup"><span data-stu-id="2ad30-133">INPUTS</span></span>

### <span data-ttu-id="2ad30-134">System. String</span><span class="sxs-lookup"><span data-stu-id="2ad30-134">System.String</span></span>

## <span data-ttu-id="2ad30-135">НАПРЯЖЕНИЕ</span><span class="sxs-lookup"><span data-stu-id="2ad30-135">OUTPUTS</span></span>

### <span data-ttu-id="2ad30-136">Microsoft. Azure. Commands. Security. Models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="2ad30-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="2ad30-137">Пуск</span><span class="sxs-lookup"><span data-stu-id="2ad30-137">NOTES</span></span>

## <span data-ttu-id="2ad30-138">ДОПОЛНИТЕЛЬНЫЕ ССЫЛКИ</span><span class="sxs-lookup"><span data-stu-id="2ad30-138">RELATED LINKS</span></span>
