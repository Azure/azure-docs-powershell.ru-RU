...
ms.locfileid: "93729255"
---
# <span data-ttu-id="f1c86-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="f1c86-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="f1c86-102">КРАТКИй обзор</span><span class="sxs-lookup"><span data-stu-id="f1c86-102">SYNOPSIS</span></span>
<span data-ttu-id="f1c86-103">Получение оповещений системы безопасности, обнаруженных центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="f1c86-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="f1c86-104">Максимальное</span><span class="sxs-lookup"><span data-stu-id="f1c86-104">SYNTAX</span></span>

### <span data-ttu-id="f1c86-105">SubscriptionScope (по умолчанию)</span><span class="sxs-lookup"><span data-stu-id="f1c86-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="f1c86-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="f1c86-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="f1c86-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="f1c86-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="f1c86-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="f1c86-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="f1c86-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="f1c86-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="f1c86-110">NОПИСАНИЕ</span><span class="sxs-lookup"><span data-stu-id="f1c86-110">DESCRIPTION</span></span>
<span data-ttu-id="f1c86-111">Получение оповещений системы безопасности, обнаруженных центром безопасности Azure</span><span class="sxs-lookup"><span data-stu-id="f1c86-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="f1c86-112">ИЛЛЮСТРИРУЮТ</span><span class="sxs-lookup"><span data-stu-id="f1c86-112">EXAMPLES</span></span>

### <span data-ttu-id="f1c86-113">Пример 1</span><span class="sxs-lookup"><span data-stu-id="f1c86-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="f1c86-114">Возвращает все оповещения системы безопасности, обнаруженные в resoruces в рамках подписки.</span><span class="sxs-lookup"><span data-stu-id="f1c86-114">Gets all the security alerts that were detected on resoruces inside a subscription</span></span>

### <span data-ttu-id="f1c86-115">Пример 2</span><span class="sxs-lookup"><span data-stu-id="f1c86-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="f1c86-116">Возвращает все оповещения системы безопасности, обнаруженные в resoruces в группе ресурсов "myService1".</span><span class="sxs-lookup"><span data-stu-id="f1c86-116">Gets all the security alerts that were detected on resoruces inside the "myService1" resource group</span></span>

### <span data-ttu-id="f1c86-117">Пример 3</span><span class="sxs-lookup"><span data-stu-id="f1c86-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="f1c86-118">Получает особое предупреждение системы безопасности, обнаруженное в resoruces в группе ресурсов "myService1".</span><span class="sxs-lookup"><span data-stu-id="f1c86-118">Gets a specific security alert that were detected on resoruces inside the "myService1" resource group</span></span>

## <span data-ttu-id="f1c86-119">ПАРАМЕТРЫ</span><span class="sxs-lookup"><span data-stu-id="f1c86-119">PARAMETERS</span></span>

### <span data-ttu-id="f1c86-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="f1c86-120">-DefaultProfile</span></span>
<span data-ttu-id="f1c86-121">Учетные данные, учетная запись, клиент и подписка, используемые для связи с Azure.</span><span class="sxs-lookup"><span data-stu-id="f1c86-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="f1c86-122">-Location</span><span class="sxs-lookup"><span data-stu-id="f1c86-122">-Location</span></span>
<span data-ttu-id="f1c86-123">Поиска.</span><span class="sxs-lookup"><span data-stu-id="f1c86-123">Location.</span></span>
...
### <span data-ttu-id="f1c86-124">-Name (имя)</span><span class="sxs-lookup"><span data-stu-id="f1c86-124">-Name</span></span>
<span data-ttu-id="f1c86-125">Название ресурса.</span><span class="sxs-lookup"><span data-stu-id="f1c86-125">Resource name.</span></span>
...
### <span data-ttu-id="f1c86-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="f1c86-126">-ResourceGroupName</span></span>
<span data-ttu-id="f1c86-127">Имя группы ресурсов.</span><span class="sxs-lookup"><span data-stu-id="f1c86-127">Resource group name.</span></span>
...
### <span data-ttu-id="f1c86-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="f1c86-128">-ResourceId</span></span>
<span data-ttu-id="f1c86-129">Идентификатор ресурса.</span><span class="sxs-lookup"><span data-stu-id="f1c86-129">Resource ID.</span></span>
...
### <span data-ttu-id="f1c86-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="f1c86-130">CommonParameters</span></span>
<span data-ttu-id="f1c86-131">Этот командлет поддерживает общие параметры:-Debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-of Variable,-out,-PipelineVariable,-Verbose, и-WarningAction.</span><span class="sxs-lookup"><span data-stu-id="f1c86-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="f1c86-132">Дополнительные сведения можно найти в разделе about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="f1c86-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="f1c86-133">ВХОДНЫЕ данные</span><span class="sxs-lookup"><span data-stu-id="f1c86-133">INPUTS</span></span>

### <span data-ttu-id="f1c86-134">System. String</span><span class="sxs-lookup"><span data-stu-id="f1c86-134">System.String</span></span>

## <span data-ttu-id="f1c86-135">НАПРЯЖЕНИЕ</span><span class="sxs-lookup"><span data-stu-id="f1c86-135">OUTPUTS</span></span>

### <span data-ttu-id="f1c86-136">Microsoft. Azure. Commands. Security. Models. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="f1c86-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="f1c86-137">Пуск</span><span class="sxs-lookup"><span data-stu-id="f1c86-137">NOTES</span></span>

## <span data-ttu-id="f1c86-138">ДОПОЛНИТЕЛЬНЫЕ ССЫЛКИ</span><span class="sxs-lookup"><span data-stu-id="f1c86-138">RELATED LINKS</span></span>
