...
<span data-ttu-id="68139-126">Следующий код позволяет экспортировать секрет:</span><span class="sxs-lookup"><span data-stu-id="68139-126">The following code will allow you to export the secret:</span></span>
